...
export default function EndFree() {
  ...
  const definition =
    "End-Free Alignment is used to find overlap between two or more sequences i.e, alignment of start of one sequence to end of other. It is used in building genome fragements out of shorter sequencing data.";
